...
#[tauri::command]
pub async fn get_watchlist(app: AppHandle) -> Result<Vec<WatchlistEntry>, String> {
...
#[tauri::command]
pub async fn remove_from_watchlist(app: AppHandle, coin_id: String) -> Result<(), String> {
...
#[tauri::command]
pub async fn fetch_chart(coin_id: String, days: u32) -> Result<Vec<(i64, f64)>, String> {
...
#[tauri::command]
pub async fn fetch_news(app: AppHandle, symbols: Vec<String>) -> Result<Vec<NewsItem>, String> {
...
#[tauri::command]
pub async fn ai_analyze_coin(app: AppHandle, coin_id: String) -> Result<String, String> {
    ...
    let chart_summary = if chart.len() > 1 {
        ...
        format!(
            "30-Tage: Start €{:.2} → Aktuell €{:.2} ({:+.1}%), {} Datenpunkte",
            first,
            last,
            pct,
            chart.len()
...
#[tauri::command]
pub async fn get_api_key_exists(app: AppHandle, provider: String) -> Result<bool, String> {
    let key = db::get_api_key(&app, &provider)
        .await
        .map_err(|e| e.to_string())?;
...
#[tauri::command]
pub async fn delete_alert_rule(app: AppHandle, id: i64) -> Result<(), String> {
...
#[tauri::command]
pub async fn toggle_alert_rule(app: AppHandle, id: i64, enabled: bool) -> Result<(), String> {
...
#[tauri::command]
pub async fn search_coins(query: String) -> Result<Vec<CoinSearchResult>, String> {
    coingecko::search_coins(&query).await.map_err(|e| e.to_string())
}
